...
/**
 * Post/artigo de blog (tabela {@code posts}). Estruturalmente idêntico a
 * {@code Project}, trocando {@code image}/{@code projectUrl}/{@code repoUrl} por
 * {@code imageUrl}/{@code content}, e com uma rota pública a mais (busca por slug).
 *
 * Fonte no Nest: apps/api/src/db/schema/posts.ts
 */
@Entity
@Table(name = "posts")
